...
def main():
    ...
    x_cut_margin = 0.2
    y_cut_margin = 0.5
    x_min, x_max, y_min, y_max = compute_spatial_cut_bounds(df_phys, parameters, tag="nominal")
    ...
    y_min_grid, y_max_grid = compute_torsion_grid_bounds(df_phys, parameters, sigma_mult=2.0, tag="nominal")
